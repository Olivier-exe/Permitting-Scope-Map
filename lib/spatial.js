...
export function generatePermits(r) {
  ...
  if (r.rr.length) {
    var rr = r.rr[0];
    pm.push({ type: 'Railroad Crossing Permit', jurisdiction: rr.o, recommendation: rr.o + ' track ' + rr.d + 'm away' + (rr.dir ? ' to the ' + rr.dir : ''), priority: rr.d < 50 ? 'Critical' : 'High', notes: 'Contact railroad company + LPSC notification' });
  }
